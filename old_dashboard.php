    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="logout.php" class="btn btn-danger">Logout <span class="sr-only">(current)</span></a>
        </li>
				...
				<div class="card table-card review-card">
                    ...
                    <div class="card-body pb-0">
                        <div class="review-block">
                            <div class="row">
                                <div class="col">
                                    <h6 class="m-b-15">Confirm that your details are correct</h6>
									<p><strong>Names:</strong> <?php echo $_SESSION['name'];  ?></p>
