...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  <a href="#"><img src="../img/logo.png" alt="" width="30%" class="heartbeat-image"></a>
  ...
  <li class="nav-item">
        <a class="nav-link text-white" href="#"> <b> Permission Duration: <?php echo $_SESSION['exp_data']; ?> </b> </a>
      </li> 
  <li class="nav-item">
        <a class="nav-link text-white" href="#"> <b> Welcome, <?php echo $_SESSION['user_name']; ?> </b> </a>
      </li>  
    
      <li class="nav-item">
        <a class="nav-link text-white" href="logout.php"> <b>Logout</b> </a>
      </li>    
    </ul>
  </div>
</nav>
