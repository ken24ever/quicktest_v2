...
<head>
	...
	<title>Admin | Live Score Test</title>
	...
	<!-- vendor css -->
	<link rel="stylesheet" href="css/style.css">  <link rel="icon" type="image/png" sizes="32x32" href="../img/favicon.png">
	...
	<div class="auth-content text-center" style="margin-top:15px;">
		...
		<div class="card borderless">
			<div class="row align-items-center ">
				<div class="col-md-12">
					<div class="card-body">
						<h4 class="mb-3 f-w-400"><strong>Welcome Admin!</strong></h4>
						<hr>
						<form id="loginForm">
